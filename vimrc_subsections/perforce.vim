...
map <silent> ,diff :update<CR>:silent !cmd /c "(p4 login -s \|\| p4 login) && C:\Progra~1\Perforce\P4v.exe -cmd "diff %:p""<CR>
map <silent> ,hist :update<CR>:silent !"(p4 login -s \|\| p4 login) && p4v -cmd "history %:p"<CR>
map <silent> ,revert mz<F5>:!cmd /c "(p4 login -s \|\| p4 login) && p4 revert "%""<CR>:e!<CR>`z
